!(function (t, e) {
    ...
    a.prototype = {
        ...
        _setValidator: function (t, e, i) {
            for (var n in ("object" !== r(e) && (e = { fn: e, priority: i }), e.validate || (e = new c(e)), (this.validators[t] = e).messages || {})) this.addMessage(n, t, e.messages[n]);
            return this;
        },
    ...
    var x = o(new s(), { element: document, $element: h(document), actualizeOptions: null, _resetOptions: null, Factory: A, version: "@@version" });
    ...
    (window.ParsleyValidator = {}),
        ...
        h.each("addError updateError".split(" "), function (t, a) {
            window.ParsleyUI[a] = function (t, e, i, n, r) {
                var s = !0 !== r;
                return d.warnOnce("Accessing UI is deprecated. Call '".concat(a, "' on the instance directly. Please comment in issue 1073 as to your need to call this method.")), t[a](e, { message: i, assert: n, updateClass: s });
            };
        }),
    ...
    return (
        ...
        x.addValidator("remote", {
            ...
            validateString: function (t, e, i, n) {
                ...
                (r = h.extend(!0, {}, { url: e, data: a, type: "GET" }, l)), n.trigger("field:ajaxoptions", n, r), (s = h.param(r)), void 0 === x._remoteCache && (x._remoteCache = {});
        ...
        x.addMessages("en", {
            ...
            minlength: "Cette valeur est trop courte. ça doit  avoir %s characters ou plus.",
